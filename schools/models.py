...
class School(models.Model):
    ...
    level=models.CharField(_('School District'), max_length=30, choices=LEVEL_CHOICES)
    male=models.IntegerField(_('Male School'), default=0)
    female=models.IntegerField(_('Female School'), default=0)
    ...
    location=models.IntegerField(_('School location'), srid=4326)
